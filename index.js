...
app.get('/', (req, res) => res.send('Pirate is the best dev ever  JavaScipt god!'))

app.listen( port , () =>
console.log(`Your app is playing a .help By PiRaTe`)
);
...
client.on("ready", async () => {
  ...
  client.user
    .setActivity(`Moderation Bot by PiRaTe|.help <for info>`, { type: "PLAYING" })
